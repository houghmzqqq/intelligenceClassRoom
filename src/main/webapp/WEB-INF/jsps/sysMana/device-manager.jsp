...
<div class="sidebar-nav">
    <ul>
        ...
        <li><ul class="dashboard-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/sysMana/devControlView"><span class="fa fa-caret-right"></span> 设备控制</a></li>
...
<div class="content">
    ...
    <div class="main-content">
        ...
        <div class="btn-toolbar list-toolbar">
            ...
            <form action="${pageContext.request.contextPath}/sysMana/toDevManaView" method="post" class="form-inline">
                <input type="hidden" name="thisPage" value="1"/>
                <div class="form-group">
                    <label>设备类型：</label>
                    <select name="devTypeId" class="form-control">
                        <option value="0">全部</option>
                        <c:forEach var="deviceTypePO" items="${deviceTypePOS}">
                            <option value="${deviceTypePO.devTypeId}">${deviceTypePO.devTypeName}</option>
                        </c:forEach>
                    </select>
        ...
        <table class="table">
            ...
            <c:forEach var="devicePO" items="${devicePOS}">
                <tr>
                    <th>${devicePO.deviceId}</th>
                    <th>${devicePO.deviceTypePO.devTypeName}</th>
                    <th>${devicePO.createDate}</th>
                    <th>${devicePO.deviceByname}</th>
                    <th>
                        <a href="${pageContext.request.contextPath}/stu/toUpdate?studentId=${devicePO.studentId}">[编辑]</a>
                        <a href="${pageContext.request.contextPath}/stu/toDelete?studentId=${devicePO.studentId}">[禁用]</a>
                        <a href="${pageContext.request.contextPath}/stu/toUpdate?studentId=${devicePO.studentId}">[编辑]</a>
                        <a href="${pageContext.request.contextPath}/stu/toDelete?studentId=${devicePO.studentId}">[指令设置]</a>
                    </th>
                    <th style="width: 3.5em;"></th>
                </tr>
            </c:forEach>
        ...
        <ul class="pagination">
            <li><a href="${pageContext.request.contextPath }/sysMana/toDevManaView?thisPage=${dividePage.prePage}&devTypeId=${devTypeId}">&laquo;</a></li>
            ...
            <c:forEach begin="${start}" end="${end}" step="1" var="i">
                ...
                <c:if test="${i != dividePage.thisPage}">
                    <li><a href="${pageContext.request.contextPath}/sysMana/toDevManaView?thisPage=${i}&devTypeId=${devTypeId}">${i}</a></li>
                </c:if>
            </c:forEach>
            <li><a href="${pageContext.request.contextPath }/sysMana/toDevManaView?thisPage=${dividePage.nextPage}&devTypeId=${devTypeId}">&raquo;</a></li>
        </ul>
