...
<div class="sidebar-nav">
    <ul>
        <li><a href="#" data-target=".dashboard-menu" class="nav-header" data-toggle="collapse"> 系统管理<i class="fa fa-collapse"></i></a></li>
...
<div class="content">
    ...
    <div class="main-content">
       <%-- <div class="btn-toolbar list-toolbar">
            ...
            <form action="${pageContext.request.contextPath}/stu/toView" method="post" class="form-inline">
                ...
                <div class="form-group">
                    ...
                    <select name="classId" class="form-control">
                        ...
                        <c:forEach var="classesPO" items="${classesPOS}">
                            <option value="${classesPO.classId}">${classesPO.className}</option>
                        </c:forEach>
                    </select>
        ...
        <c:forEach var="devicePO" items="${devicePOS}">
            <tr>
                ...
                <th>未定义设备名称</th>
                <th>
                    <c:if test="${devicePO.status==0}">关闭</c:if>
                    <c:if test="${devicePO.status==1}">打开</c:if>
                </th>
                <th>
                    <a href="${pageContext.request.contextPath}/sysMana/doOpen?devId=${devicePO.deviceId}">打开</a>
                    <a href="${pageContext.request.contextPath}/sysMana/doClose?devId=${devicePO.deviceId}">关闭</a>
                </th>
            </tr>
        </c:forEach>
        </thead>
