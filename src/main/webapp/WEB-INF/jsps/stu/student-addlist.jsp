...
<div class="sidebar-nav">
    <ul>
        ...
        <li><ul class="accounts01-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/stu/toAddList"><span class="fa fa-caret-right"></span>学生批量导入</a></li>
            ...
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" method="post" action="${pageContext.request.contextPath }/stu/addList" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>数据文件</label>
                                <input type="file" name="stulist" required="required" class="form-control">
                            </div>
