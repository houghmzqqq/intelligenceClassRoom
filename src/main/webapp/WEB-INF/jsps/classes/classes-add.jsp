...
<div class="sidebar-nav">
    <ul>
        ...
        <li><a href="#" data-target=".legal-menu" class="nav-header" data-toggle="collapse"> 班级管理<i class="fa fa-collapse"></i></a></li>
        <li><ul class="legal-menu nav nav-list collapse in">
            <li class="active"><a href="nav03-class-add.jsp"><span class="fa fa-caret-right"></span>添加班级</a></li>
...
<div class="content">
    ...
    <div class="main-content">
        ...
        <div class="row">
            ...
            <form method="post" id="tab" action="${pageContext.request.contextPath}/classes/toAdd">
            <div class="col-md-4">
                <br>
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                            ...
                            <div class="form-group">
                                <label>班级编号</label>
                                <input name="classId" value="${classesPO.classId}" type="text" required="required" maxlength="12" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>班级名称</label>
                                <input name="className" value="${classesPO.className}" type="text" required="required" class="form-control">
                            </div>
                            <div class="form-group">
                                <label>年级</label>
                                <input name="grade" value="${classesPO.grade}" type="text" required="required" class="form-control">
                                </select>
                            </div>
                            <div class="form-group">
                                <label>专业</label>
                                <input name="major" value="${classesPO.major}" type="text" required="required" class="form-control">
                            </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="error-text"><i class="fa fa-warning modal-icon"></i>确定要删除该班级吗?<br></p>
                    </div>
