...
<div class="sidebar-nav">
    <ul>
        ...
        <li><ul class="legal-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="nav03-class-view.jsp"><span class="fa fa-caret-right"></span>班级视图</a></li>
        </ul></li>
...
<div class="content">
    ...
    <div class="main-content">
        ...
        <table class="table">
            ...
            <c:forEach var="studentPO" items="${studentPOS}">
                <tr>
                    <th>${studentPO.studentId}</th>
                    <th>${studentPO.studentName}</th>
                    <th>${studentPO.RFID}</th>
                    <th>${studentPO.gender}</th>
                    <th>
                        <a href="${pageContext.request.contextPath}/stu/toUpdate?studentId=${studentPO.studentId}">[编辑]</a>
                        <a href="${pageContext.request.contextPath}/stu/toDelete?studentId=${studentPO.studentId}">[删除]</a>
                    </th>
                    <th style="width: 3.5em;"></th>
                </tr>
            </c:forEach>
