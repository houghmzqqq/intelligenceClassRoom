...
<div class="content">
    ...
    <div class="main-content">
        ...
        <table class="table">
            ...
            <c:forEach var="classesPOS" items="${classesPOS}">
                <tr>
                    <th>${classesPOS.classId}</th>
                    <th>${classesPOS.className}</th>
                    <th>${classesPOS.grade}</th>
                    <th><a href="${pageContext.request.contextPath}/record/toClassView">[查看详情]</a></th>
                    <th style="width: 3.5em;"></th>
                </tr>
            </c:forEach>
        ...
        <ul class="pagination">
            <li><a href="${pageContext.request.contextPath }/record/toClassView?thisPage=${dividePage.prePage}">&laquo;</a></li>
            ...
            <c:forEach begin="${start}" end="${end}" step="1" var="i">
                ...
                <c:if test="${i != dividePage.thisPage}">
                    <li><a href="${pageContext.request.contextPath}/record/toClassView?thisPage=${i}">${i}</a></li>
                </c:if>
            </c:forEach>
            <li><a href="${pageContext.request.contextPath }/record/toClassView?thisPage=${dividePage.nextPage}">&raquo;</a></li>
        </ul>
