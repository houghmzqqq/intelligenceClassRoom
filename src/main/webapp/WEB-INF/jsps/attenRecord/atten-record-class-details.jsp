...
<div class="sidebar-nav">
    <ul>
        ...
        <li><a href="#" data-target=".accounts04-menu" class="nav-header" data-toggle="collapse"> 考勤数据<i class="fa fa-collapse"></i></a></li>
        <li><ul class="accounts04-menu nav nav-list collapse in">
            <li ><a href="${pageContext.request.contextPath}/record/toStuRecodeView"><span class="fa fa-caret-right"></span>学生记录查询</a></li>
            <li class="active"><a href="nav08-attendance-record-update.jsp"><span class="fa fa-caret-right"></span>班级记录查询</a></li>
        </ul></li>
...
<div class="content">
    <div class="header">
        ...
        <h1 class="page-title">考勤数据</h1>
        <ul class="breadcrumb">
            <li><a href="../index.jsp">Home</a> </li>
            <li class="active">学生记录查询</li>
        </ul>
    ...
    <div class="main-content">
        ...
        <div class="btn-toolbar list-toolbar">
            ...
            <form action="${pageContext.request.contextPath}/record/findByName" method="post" class="form-inline">
                <input type="hidden" name="thisPage" value="1"/>
                <div class="form-group">
                    <label>学生姓名：</label>
                    <input name="stuName" value="<c:if test="${stuName!='no'}">${stuName}</c:if>" type="text" class="form-control">
                </div>
        ...
        <table class="table">
            ...
            <c:forEach var="studentRecordVO" items="${studentRecordVOS}">
                <tr>
                    <th>${studentRecordVO.studentId}</th>
                    <th>${studentRecordVO.studentName}</th>
                    <th>${studentRecordVO.courseName}</th>
                    <th>${studentRecordVO.className}</th>
                    <th>${studentRecordVO.status}</th>
                    <th>${studentRecordVO.date}</th>
                    <th><a href="${pageContext.request.contextPath}/stu/toUpdate?studentId=${studentPO.studentId}">[查看详情]</a></th>
                    <th style="width: 3.5em;"></th>
                </tr>
            </c:forEach>
        ...
        <ul class="pagination">
            <li><a href="${pageContext.request.contextPath }/record/toStuRecodeView?thisPage=${dividePage.prePage}&stuName=${stuName}">&laquo;</a></li>
            ...
            <c:forEach begin="${start}" end="${end}" step="1" var="i">
                ...
                <c:if test="${i != dividePage.thisPage}">
                    <li><a href="${pageContext.request.contextPath}/record/toStuRecodeView?thisPage=${i}&stuName=${stuName}">${i}</a></li>
                </c:if>
            </c:forEach>
            <li><a href="${pageContext.request.contextPath }/record/toStuRecodeView?thisPage=${dividePage.nextPage}&stuName=${stuName}">&raquo;</a></li>
        </ul>
