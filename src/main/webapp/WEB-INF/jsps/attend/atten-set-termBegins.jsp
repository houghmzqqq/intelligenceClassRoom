...
<div class="sidebar-nav">
    <ul>
        ...
        <li><ul class="accounts03-menu nav nav-list collapse in">
            ...
            <li class="active"><a href="${pageContext.request.contextPath}/couSch/toSetTermView"><span class="fa fa-caret-right"></span>设置开学周星期一</a></li>
        </ul></li>
            ...
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form:form method="post" id="tab" action="${pageContext.request.contextPath}/couSch/setTermBegin" modelAttribute="termBegin">
                            ...
                            <div class="form-group">
                                <label>开学日期</label>
                                <input name="beginTime" class="form-control" path="beginTime" />
                                <form:errors path="beginTime" />
