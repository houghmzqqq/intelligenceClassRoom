    ...
    <div class="main-content">
       ...
       <%-- <div class="btn-toolbar list-toolbar">
        ...
        <table class="table">
            ...
            <c:forEach var="amPO" items="${amPOS}">
                <tr>
                    <th>${amPO.attendanceMachineId}</th>
                    <th>${amPO.IP}</th>
                    <th>${amPO.port}</th>
                    <th>${amPO.classroomPO.roomId}</th>
                    <th>${amPO.status}</th>
                    <th>
                        <a href="${pageContext.request.contextPath}/attendance/toUpdate?attenId=${amPO.attendanceMachineId}">[修改]</a>
                        <a href="${pageContext.request.contextPath}/attendance/toDelete?attenId=${amPO.attendanceMachineId}">[删除]</a>
                    </th>
                    <th style="width: 3.5em;"></th>
                </tr>
            </c:forEach>
