...
<div class="sidebar-nav">
    <ul>
        ...
        <li><a href="#" data-target=".accounts02-menu" class="nav-header" data-toggle="collapse"> 课表管理<i class="fa fa-collapse"></i></a></li>
        <li><ul class="accounts02-menu nav nav-list collapse in">
            <li class="active"><a href="${pageContext.request.contextPath}/couSch/toAddView"><span class="fa fa-caret-right"></span>录入课表</a></li>
            ...
            <div class="col-md-4">
                ...
                <div id="myTabContent" class="tab-content">
                    <div class="tab-pane active in" id="home">
                        <form id="tab" method="post" action="${pageContext.request.contextPath }/couSch/addCouSchs" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                <label>数据文件</label>
                                <input type="file" name="couSch" class="form-control">
                            </div>
